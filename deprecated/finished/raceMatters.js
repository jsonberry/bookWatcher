...
const book = 'Race Matters'
const pages = 151
const startDate = moment('2017-05-24')
const dueDate = moment('2017-07-01')
const finishedDate = moment('2017-06-20')
...
if (status === 'finished') {
    ...
    console.log(
        ...
        `Finished Date: ${obj.finishedDate}\n`,
        `Days took to complete: ${obj.daysToComplete}\n`,
        `Pages Read Per Day: ${obj.daysToComplete}\n`,
